...
def main(argv=None):
    ...
    config_flat = config_flat.update(simple_params)
    ...
    print(f"[Train SimPLe] Config saved to {config_file}")
    print("OBS SPACE:", env.obs_space)

    # === Initialize Agent and Training ===
    agent = SimPLeAgent(env.obs_space, env.act_space, dreamerv3_config)
